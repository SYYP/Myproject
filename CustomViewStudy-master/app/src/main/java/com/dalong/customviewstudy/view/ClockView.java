...
public class ClockView extends View {
    ...
    public ClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSmallScaleColor=typedArray.getColor(R.styleable.ClockView_mSmallScaleColor,Color.BLUE);
        mMiddlecaleColor=typedArray.getColor(R.styleable.ClockView_mMiddlecaleColor,Color.CYAN);
        mHourHandColor=typedArray.getColor(R.styleable.ClockView_mHourHandColor,Color.GREEN);
